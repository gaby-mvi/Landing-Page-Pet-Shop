            ...
            <div className="container px-4 mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="space-y-6 mt-10" data-aos="fade-up-left" data-aos-delay="300">
                        ...
                        <p>Until one has loved an animal, a part of one's soul remains unawakened.
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-center gap-2">
                                ...
                                Aberto desde 2006.</li>
                            <li className="flex items-center gap-2">
                                <Check className="text-red-500" />
                                Equipe com mais de 10 veterinários.</li>
                            <li className="flex items-center gap-2">
                                <Check className="text-red-500" />
                                Qualidade é nossa prioridade.</li>
                        </ul>
                        <div className="flex gap-2">
                            <a href={`https://wa.me/5548900008800?text=Olá vim pelo site e gostaria de mais informações`}
                                target="_blank"
                                className="bg-[#E84c3d] text-white flex items-center w-fit gap-2 px-4 py-2 rounded-md hover:bg-red-400 transition">
                                <WhatsappLogo className='w-5 h-5 text-white' />
                                Contato via WhatsApp
                            </a>
                            <a href="#" className="flex items-center w-fit gap-2 px-4 py-2 rounded-md">
